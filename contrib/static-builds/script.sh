...
find ${DISTNAME}/bin -type f -executable -exec ../aipgcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../aipgcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/aipgcoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/aipgcoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
