...
class RewardsTest(AIPGTestFramework):
    ...
    def basic_test_asset_uneven_distribution(self):
        ...
        n0.transferfromaddress(asset_name="STOCK8", from_address=dist_addr0, qty=300, to_address=shareholder_addr0,
                               message="", expire_time=0, AIPG_change_address="", asset_change_address=dist_addr0)
    ...
    def basic_test_asset_round_down_uneven_distribution_3(self):
        ...
        self.log.info("Distributing shares")
        n0.transferfromaddress(asset_name="STOCK12", from_address=dist_addr0, qty=9, to_address=shareholder_addr0, message="", expire_time=0, AIPG_change_address="", asset_change_address=dist_addr0)
        n0.transferfromaddress(asset_name="STOCK12", from_address=dist_addr0, qty=3, to_address=shareholder_addr1, message="", expire_time=0, AIPG_change_address="", asset_change_address=dist_addr0)
        n0.transferfromaddress(asset_name="STOCK12", from_address=dist_addr0, qty=2, to_address=shareholder_addr2, message="", expire_time=0, AIPG_change_address="", asset_change_address=dist_addr0)
        n0.transferfromaddress(asset_name="STOCK12", from_address=dist_addr0, qty=1, to_address=shareholder_addr3,  message="", expire_time=0, AIPG_change_address="", asset_change_address=dist_addr0)
    ...
    def test_AIPG_bulk(self):
        ...
        for address in address_list:
            n0.transferfromaddress(asset_name="BULK1", from_address=dist_addr0, qty=10, to_address=address, message="",
                                   expire_time=0, AIPG_change_address="", asset_change_address=dist_addr0)
            count += 1
            if count > 190:
                n0.generate(1)
                count = 0
