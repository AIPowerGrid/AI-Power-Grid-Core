AIPG Core version *2.2.2* is now available!!
==============

  <https://github.com/AIPGProject/AIPGcoin/releases/tag/v2.2.2>
...
- Enhancements for AIPGcoin Dev Kit and Mobile Wallet Support
...
Changelog available here: <https://github.com/AIPGProject/AIPGcoin/commits/release_2.2.2>
