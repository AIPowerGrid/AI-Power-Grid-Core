AIPG Core version *2.1.0* is now available!!
==============

  <https://github.com/AIPGProject/AIPGcoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/AIPGProject/AIPGcoin/commits/release_2.1.0>
