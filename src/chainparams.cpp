...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 100000;  //~ 4 yrs at 1 min block time
    ...
    uint32_t nGenesisTime = 1688352006; // October 30, 2023, at 00:00:00 UTC
        ...
        nKAAAWWWPOWActivationTime = 1689788400; // UTC: Wed Nov 15 2023 17:00:00
...
*/
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000000b0168a1b8628233270b590125532a4bfc2a4fd21e8b1fa111aef3ae3ea"));
        assert(genesis.hashMerkleRoot == uint256S("7fd7c4aa544bff358ba457a6865573640fef153d50c16eadbde886b96e2d4a4d"));
