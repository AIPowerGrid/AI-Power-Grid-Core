...
Below are some notes on how to build AIPG Core for Windows.
...
way. This will install to `c:\workspace\aipg`, for example:

    make install DESTDIR=/mnt/c/workspace/aipg
