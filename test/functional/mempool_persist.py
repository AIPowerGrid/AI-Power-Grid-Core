...
By default, aipgd will dump mempool on shutdown and
...
class MempoolPersistTest(AipgTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give aipgd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent aipgd from writing mempool.dat to disk. Verify that `savemempool` fails")
