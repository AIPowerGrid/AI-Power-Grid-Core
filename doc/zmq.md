...
The AIPG Core daemon can be configured to act as a trusted "border
router", implementing the aipg wire protocol and relay, making
...
The ZeroMQ feature in AIPG Core requires the ZeroMQ API >= 4.0.0
...
These options can also be provided in aipg.conf.
