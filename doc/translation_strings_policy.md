...
This document provides guidelines for internationalization of the AIPG Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `aipg_en.ts` remains unchanged.
